          ...
          >
            ...
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <br />
                <div className="mt-2">
                  <div className="wrapper-scroll do-nicescroll left-align page-term" tabindex="5000" style="overflow: hidden; outline: none; cursor: -webkit-grab;">
                    <section>

                      <h3 className="title-with-border">1. บทนำ</h3> 
                      <div className="_f-system">
                        <p>บริษัทคือ บริษัท เทลสกอร์ จำกัด เป็นสื่อกลางระหว่าง Influencer 
                          กับ Marketer ที่ต้องการสร้างปรากฏการณ์การสื่อสารแบบใหม่ที่ทรงประสิทธิภาพ</p> 
                        <p>บริษัทเชื่อว่า การสร้างการรับรู้จากประสบการณ์ของผู้ใช้งานควบคู่กับการมีส่วนร่วมจากแบรนด์ 
                          คือ สิ่งสำคัญที่จะทำให้การสื่อสารมีความหมาย น่าจดจำ
                           และไปได้ไกลกว่าการโฆษณาทั่วไป ซึ่งจะทำให้เกิดเป็นปรากฏการณ์การสื่อสารแบบใหม่ 
                           ที่ทรงประสิทธิภาพและวัดผลได้แม่นยำกว่า</p> 
                        <p>สืบเนื่องจากการเป็นสื่อกลางระหว่าง Influencer
                           หรือ Marketer ทำให้บริษัทจำเป็นต้องเก็บรวบรวมข้อมูลของท่าน 
                           เพื่อนำมาใช้และ/หรือถ่ายทอดให้แก่บุคคลที่มีความสนใจที่เข้าร่วมในระบบปฏิบัติการของเทลสกอร์ (“Saypilot Platform”) ทั้งนี้ บริษัท เทลสกอร์ จำกัด มีฐานะเป็นผู้ควบคุมข้อมูลส่วนบุคคล ตามความในพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562</p> 
                        <p>ด้วยความเคารพในความเป็นส่วนตัวของท่านทั้งหลายที่ให้เกียรติเข้าร่วมเป็นส่วนหนึ่งในการสร้างปรากฏการณ์การสื่อสารแบบใหม่ เราจึงได้กำหนดนโยบายการเก็บรวบรวม ใช้และเปิดเผยข้อมูลส่วนบุคคล (นโยบาย) ฉบับนี้ขึ้น เพื่อแจ้งให้ท่านทั้งหลาย ทั้งที่มีสถานะเป็น Influencer และ/หรือ Marketer ทราบถึงเรื่องต่างๆ ดังนี้</p> 
                        <ul className="list-bullet-gray">
                          <li>บทนำ</li> 
                          <li>บริษัทคือใคร</li>
                           <li>บริษัทเก็บรวบรวมข้อมูลของท่าน เพื่อวัตถุประสงค์อะไร</li> 
                           <li>บริษัทเก็บรวบรวมข้อมูลอะไร เพื่อนำไปใช้ หรือถ่ายทอดต่อ</li> 
                           <li>บริษัทอนุญาตให้ใครเข้าถึงข้อมูลของท่านได้บ้าง</li> 
                           <li>บริษัทคำนึงถึงสิทธิของท่านผู้เป็นเจ้าของข้อมูลอย่างไร</li> 
                           <li>การใช้งาน การดูแลรักษา การป้องกัน</li>
                            <li>การเปลี่ยนแปลงนโยบาย</li>
                            </ul><br/>
                             <p>นโยบายฉบับนี้จะใช้กับข้อมูลที่บริษัทได้รวบรวมจาก :</p> 
                             <ul className="list-bullet-gray">
                               <li>Saypilot Platform</li>
                                <li>อีเมล์ ข้อความ และข้อความอิเล็กทรอนิกส์อื่นที่ท่านได้สื่อสารกับ Saypilot Platform</li> 
                                <li>แอปพลิเคชันบนโทรศัพท์มือถือ และบนคอมพิวเตอร์ ที่ท่านดาวน์โหลดจาก Saypilot Platform ที่มีระบบปฏิบัติการระหว่างกันได้โดยลำพังแบบไม่ต้องผ่านเบราเซอร์ (non-browser-based interaction) ระหว่างท่าน และ Saypilot Platform นี้</li>
                                </ul>
                                <br/>
                                 <p>นโยบายนี้ไม่ใช้กับข้อมูลที่ได้รับจาก :</p>
                                  <ul className="list-bullet-gray">
                                    <li>ช่องทางแบบออฟไลน์ของบริษัท หรือผ่านทางวิธีการอื่นใดที่ดำเนินการโดยบริษัท หรือบุคคลภายนอกใดๆ (รวมถึงบริษัทในเครือ และบริษัทย่อย) หรือ</li> 
                                    <li>บุคคลภายนอกใดๆ (รวมถึงบริษัทในเครือ และบริษัทย่อย) ซึ่งรวมถึงช่องทางผ่านทางแอปพลิเคชัน หรือเนื้อหาใดๆ (รวมถึงโฆษณา) ซึ่งอาจเชื่อมต่อไปยัง หรือสามารถเข้าถึงได้จากหรือบน Saypilot Platform</li>
                                    </ul>
                                    <br/>
                                     <p>บริษัทขอให้ท่านโปรดอ่านนโยบายฉบับนี้อย่างละเอียด เพื่อให้เข้าใจถึงนโยบาย แนวทางและวิธีปฏิบัติของบริษัทเกี่ยวกับข้อมูลของท่าน หากท่านเห็นว่านโยบาย แนวทางและวิธีปฏิบัติของบริษัทไม่ตรงตามความประสงค์ของท่าน ท่านสามารถเลือกที่จะไม่ใช้งาน Saypilot Platform ได้ อย่างไรก็ดี หากท่านเห็นว่า ท่านได้รับความคุ้มครองอย่างเหมาะสมจากนโยบาย แนวทางและวิธีปฏิบัติของเราเกี่ยวกับข้อมูลของท่านและท่านประสงค์จะให้ความยินยอมแก่บริษัทในการเก็บรวบรวม ใช้ และเปิดเผยข้อมูลของท่านแล้ว บริษัทใคร่ขอให้ท่านยืนยันการรับทราบ ยินยอมและยอมรับนโยบายฉบับนี้ โดยการกดเครื่องหมาย&nbsp;
                                       <strong>“ยอมรับ”</strong>
                                       &nbsp;หรือ&nbsp;
                                       <strong>“Accept”</strong>&nbsp;ที่แสดงบนหน้าจอของท่าน ก่อนเริ่มการใช้ Saypilot Platform</p> 
                                       <p>บริษัทใคร่ขอแจ้งให้ท่านทราบ ณ ที่นี้ว่า นโยบายความฉบับนี้อาจถูกแก้ไข เปลี่ยนแปลง เพื่อให้สอดคล้องกับสถานการณ์ กฎ ระเบียบ ประกาศ หรือกฎหมายที่จะเกิดขึ้นในอนาคต (โปรดอ่านหัวข้อ การเปลี่ยนแปลงของนโยบาย) ทั้งนี้ บริษัทจะพยายามอย่างดีที่สุดที่จะแจ้งให้ท่านทราบถึงการเปลี่ยนแปลงดังกล่าว (โดยไม่ถือเป็นหน้าที่ของบริษัท) ในกรณีเช่นว่านั้น บริษัทใคร่รบกวนให้ท่านโปรดอ่านนโยบายเป็นระยะๆ เพื่อให้เข้าใจถึงนโยบาย แนวทางและวิธีปฏิบัติของเราเกี่ยวกับข้อมูลของท่าน ในกรณีที่ Saypilot Platform ได้แจ้งให้ทราบถึงการเปลี่ยนแปลงนโยบาย และท่านยังคงเห็นว่า ท่านได้รับความคุ้มครองอย่างเหมาะสมจากนโยบายที่เปลี่ยนแปลงไปนั้น บริษัทใคร่ขอให้ท่านยันการยอมรับนโยบายนี้ (ฉบับแก้ไข) โดยการกดเครื่องหมาย “ยอมรับ” หรือ “Accept” ที่แสดงบนหน้าจอของท่าน ก่อนเริ่มการใช้ Saypilot Platform ต่อไป</p>
                                        <p>ในกรณีที่ท่านเป็นบุคคลที่มีอายุต่ำกว่า 20 ปีบริบูรณ์ บริษัทขอเรียนให้ท่านทราบว่าภายหลังท่านกดเครื่องหมาย “ยอมรับ” หรือ “Accept” แล้ว บริษัทอาจมีขั้นตอนการดำเนินการเพิ่มเติมสำหรับท่าน ซึ่งบริษัทจะแจ้งให้ท่านทราบตามช่องทางการติดต่อที่ท่านระบุไว้</p> 
                                        <p>อย่างไรก็ตาม ท่านสามารถถอนยินยอมในการเก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลของท่านที่ได้ให้ไว้กับบริษัทได้ตลอดเวลาโดยวิธีการและช่องทางที่บริษัทกำหนดไว้ในหัวข้อที่ 2 ซึ่งการถอนความยินยอมดังกล่าวจะไม่มีผลกระทบต่อการดำเนินการของบริษัทที่ได้กระทำไปก่อนจะได้รับการแจ้งถอนความยินยอมจากท่าน</p>
                                        </div>
                                        </section>
                         <section>
                          <h3 className="title-with-border">2. บริษัทคือใคร</h3> 
                          <div className="_f-system">
                            <p>บริษัท เทลสกอร์ จำกัด จดทะเบียนเป็นนิติบุคคลประเภทบริษัทจำกัดตามกฎหมายไทย เมื่อวันที่ 14 กันยายน 2559 เพื่อประกอบกิจการให้บริการด้านการตลาดผ่านสื่อออนไลน์ โดยมีสำนักงานแห่งใหญ่ตั้งอยู่ห้อง 1701 ชั้น 17 อาคารจัตุรัสจามจุรี 319 ถนนพญาไท แขวงปทุมวัน เขตปทุมวัน กรุงเทพมหานคร 10330</p> 
                            <p>ท่านสามารถติดต่อบริษัทในฐานะของผู้ควบคุมข้อมูล เพื่อสอบถามข้อมูลเพิ่มเติมเกี่ยวกับนโยบาย และแนวทางปฏิบัติของบริษัทในส่วนที่เกี่ยวกับคุ้มครองข้อมูลส่วนบุคคลหรือแจ้งความประสงค์หรือร้องขอให้บริษัทดำเนินการใด ๆ ผ่านอีเมล์ : 
                              <a href="mailto:contact@Saypilot.com">contact@Saypilot.com</a>
                              </p>
                              </div>
                              </section>
                           <section>
                          <h3 className="title-with-border">3. บริษัทเก็บรวบรวมข้อมูลของท่าน เพื่อวัตถุประสงค์อะไร</h3> 
                          <div className="_f-system"><p>บริษัทเก็บรวบรวมข้อมูลของท่าน เพื่อนำข้อมูลของท่านไปใช้ตามวัตถุประสงค์ต่างๆ ดังนี้</p> 
                          <ul className="list-bullet-gray">
                            <li>เพื่อนำเสนอ Saypilot Platform และเนื้อหาของ Saypilot Platform ให้แก่ท่าน</li> 
                            <li>เพื่อจัดหาข้อมูล สินค้า หรือบริการซึ่งท่านร้องขอจากบริษัท</li> 
                            <li>เพื่อการติดต่อระหว่างท่าน กับ บริษัท และ/หรือ บุคคลอื่น อันเกี่ยวกับสินค้าและบริการของบริษัท และของบุคคลภายนอก ซึ่งอาจรวมถึง การนำเสนอข้อมูลของท่านในที่ต่างๆ เพื่อการโฆษณา ประชาสัมพันธ์ตัวท่านตามรูปแบบการทำงานของ Saypilot Platform ตลอดระยะเวลาที่ท่านยังคงให้ความยินยอมแก่บริษัท ตามนโยบายฉบับนี้</li>
                             <li>เพื่อให้บรรลุวัตถุประสงค์อื่นใดๆ ที่ Saypilot Platform และ/หรือที่กฎหมายกำหนด</li>
                              <li>เพื่อรวบรวมฐานข้อมูลเชิงสถิติเกี่ยวกับบริการของบริษัท</li>
                               <li>เพื่อจัดให้มีการบอกกล่าวแก่ท่าน เกี่ยวกับบัญชี/การลงชื่อติดตาม (subscription) รวมถึงการบอกกล่าวเกี่ยวกับการสิ้นอายุ และการต่ออายุ</li> 
                               <li>เพื่อปฏิบัติตามภาระหน้าที่ของบริษัท และบังคับตามสิทธิของเราที่เกิดขึ้นตามสัญญาฉบับใดๆ ที่บริษัทได้ทำกับท่าน รวมถึง การแจ้งยอดหนี้ และการเรียกเก็บเงิน</li> 
                               <li>เพื่อแจ้งท่านเกี่ยวกับการเปลี่ยนแปลงที่มีต่อ Saypilot Platform หรือสินค้า หรือบริการใดๆ ที่บริษัทได้นำเสนอ หรือจัดหาให้ผ่าน Saypilot Platform</li> 
                               <li>เพื่อให้ท่านสามารถเข้าร่วมใช้ Saypilot Platform ในลักษณะพิเศษ</li>
                                <li>เพื่อการนำไปเปิดเผยแก่บริษัทในกลุ่มและพันธมิตรของบริษัท (ซึ่งหมายถึงบริษัทที่เทลสกอร์เข้าไปถือหุ้น หรือบริษัทที่เข้ามาถือหุ้นของเทลสกอร์ หรือบริษัทที่เข้าทำสัญญาในการประกอบธุรกิจกับเทลสกอร์) เพื่อประโยชน์ในการนำเสนอสินค้าและบริการแก่ท่าน</li>
                                <li>ใช้เพื่อวิธีการอื่นตามที่บริษัทจะแจ้งให้ท่านทราบและขอความยินยอมจากท่านเพิ่มเติมต่อไปในอนาคต</li>
                                </ul> 
                                
                                <p>ในกรณีที่บริษัทใช้เทคโนโลยีจัดเก็บข้อมูลแบบอัตโนมัติ (automatic data collection technologies) นั้น อาจทำให้บริษัทได้ฐานข้อมูลเชิงสถิติ อันมีข้อมูลส่วนบุคคลรวมอยู่ด้วย หรือบริษัทอาจคงไว้ซึ่ง หรือเชื่อมโยงข้อมูลดังกล่าวกับข้อมูลส่วนบุคคลที่บริษัทได้เก็บรวบรวมมาโดยวิธีการอื่น หรือได้รับข้อมูลจากบุคคลภายนอก ข้อมูลที่ได้เหล่านั้นจะช่วยให้บริษัทสามารถปรับปรุง Saypilot Platform เพื่อให้บริการที่ดีขึ้น และที่ตรงกับความต้องการมากขึ้น ซึ่งทำให้บริษัทสามารถดำเนินการดังต่อไปนี้ได้</p> <ul className="list-bullet-gray"><li>ประเมินจำนวนและรูปแบบการใช้งานของผู้ติดตามของบริษัท</li> <li>เก็บรักษาข้อมูลเกี่ยวกับความชอบของท่าน ซึ่งทำให้บริษัทสามารถนำมาปรับเปลี่ยนรูปแบบของ Saypilot Platform ให้ตรงกับความสนใจของท่านได้</li> <li>เพิ่มความรวดเร็วให้แก่การค้นหาให้แก่ท่าน</li> <li>จดจำท่านได้ เมื่อท่านกลับมาใช้ Saypilot Platform อีกครั้ง</li></ul> 
                                <p>หากบริษัทประสงค์จะเก็บรวบรวมข้อมูลของท่านนอกเหนือไปจากวัตถุประสงค์ที่ระบุข้างต้น บริษัทจะแจ้งวัตถุประสงค์ใหม่ให้ท่านรับทราบและขอความยินยอมจากท่านอีกครั้ง</p>
                                </div>
                                </section>
                           <section>
                          <h3 className="title-with-border">4. บริษัทเก็บรวบรวมข้อมูลอะไร เพื่อนำไปใช้ หรือถ่ายทอดต่อ</h3> 
                          <div className="_f-system">
                            
                            <p>ในการให้บริการของบริษัท บริษัทมีความจำเป็นต้องขอให้ท่านกรอกข้อมูลของท่านก่อนเริ่มการใช้งาน Saypilot Platform ซึ่งหากท่านไม่ยินยอมให้ข้อมูลแก่บริษัท อาจจะส่งผลให้บริษัทไม่สามารถนำเสนอสินค้าและบริการที่เหมาะสมและตรงตามความต้องการของท่านได้ และในบางครั้ง บริษัทจำเป็นต้องเก็บรวบรวมข้อมูลของท่านจากแหล่งอื่นๆ (นอกจากการเก็บข้อมูลจากท่าน)&nbsp;ซึ่งบริษัทจะแจ้งให้ท่านทราบภายใน 30 วันนับแต่วันที่เก็บรวบรวม และในกรณีที่บริษัทจะนำข้อมูลดังกล่าวของท่านไปเปิดเผย บริษัทจะแจ้งให้ท่านทราบก่อนการนำข้อมูลนั้นไปเปิดเผยเป็นครั้งแรก โดยบริษัทมีแนวทางและวิธีการในการเก็บรวบรวมข้อมูลของท่าน ดังนี้</p> <div className="sub"><h3 className="title-with-border sub-title">4.1 การเก็บรวบรวมข้อมูล</h3> 
                            <p>บริษัทจะเก็บรวบรวมข้อมูลต่างๆ ดังนี้</p> 
                          <ul className="list-bullet-gray">
                              <li>ข้อมูลใดๆ ซึ่งทำให้สามารถระบุตัวตนของท่านได้ ไม่ว่าทางตรงหรือทางอ้อม จะถือเป็น&nbsp;<strong>“ข้อมูลส่วนบุคคล”</strong>&nbsp;ที่จะได้รับความคุ้มครองตามนโยบายฉบับนี้ ซึ่งรวมถึง
				<ul className="list-bullet-border-gray">
          <li>ข้อมูลเกี่ยวกับตัวท่าน อันได้แก่ ชื่อ นามสกุล อายุ เพศ เชื้อชาติ เผ่าพันธุ์ ความเชื่อและ/หรือความคิดเห็นในด้านต่างๆ พฤติกรรมทางเพศ ประวัติส่วนตัว ข้อมูลสุขภาพ ความถนัด และคุณสมบัติอื่นๆ</li> 
        <li>ข้อมูลเกี่ยวกับภูมิลำเนา ถิ่นที่อยู่ สถานที่ติดต่อ</li> 
        <li>ข้อมูลเกี่ยวกับการติดต่อ เช่น ที่อยู่ ที่ทำงาน อ เบอร์โทรศัพท์ บัญชีผู้ใช้ทางสื่อสังคมออนไลน์ (social media account)</li> 
        <li>การระบุตัวตนอื่นใดๆ ซึ่งท่านอาจได้รับการติดต่อผ่านทางระบบออนไลน์ หรือออฟไลน์ และ/หรือ</li> 
        <li>ข้อมูลส่วนตัวของท่านที่เปิดเผยต่อสาธารณะด้วยความยินยอมของท่าน</li>
        </ul>
        </li> 
          <li>ข้อมูลอื่นใดที่เกี่ยวกับท่าน แต่ไม่ได้ระบุถึงตัวตนของท่านเป็นการส่วนตัว และ/หรือข้อมูลที่เกี่ยวกับการเชื่อมต่ออินเทอร์เน็ตของท่าน และอุปกรณ์ที่ท่านใช้ในการเข้าถึง Saypilot Platform และข้อมูลการใช้งาน</li>
          </ul> 
          <p>ในกรณีที่บริษัทต้องการเก็บรวบรวมข้อมูลส่วนบุคคลของท่านนอกเหนือไปจากที่ระบุไว้ข้างต้น บริษัทจะแจ้งให้ท่านทราบและขอความยินยอมจากท่านอีกครั้งหนึ่ง</p>
          </div> 
          <div className="sub">
            <h3 className="title-with-border sub-title">4.2 วิธีการจัดเก็บข้อมูล</h3> 
        <p>บริษัทเก็บรวบรวมข้อมูลของท่านด้วยวิธีการต่างๆ ดังนี้</p> 
        <ul className="list-bullet-gray">
          <li>ด้วยวิธีการสื่อสารกับท่านโดยตรง และท่านเป็นผู้ให้ข้อมูลผ่านวิธีการสื่อสารนั้น</li> 
        <li>ด้วยวิธีการอัตโนมัติจากการเข้าสู่ Saypilot Platform ผ่านทางเว็บไซต์ ซึ่งข้อมูลที่ได้รับโดยอัตโนมัตินั้นอาจรวมถึงรายละเอียดการใช้งาน ที่อยู่บนเครือข่ายของคอมพิวเตอร์ (IP addresses) และข้อมูลที่ได้รับผ่านทางคุกกี้ (cookies) และเทคโนโลยีการติดตามอื่นๆ (tracking technologies)</li> 
        <li>ด้วยวิธีการติดต่อกับบุคคลอื่นๆ อาทิเช่น Influencer Marketer หรือบุคคลอื่นที่เกี่ยวข้องกับ Saypilot Platform และรวมถึงบริษัทในเครือ บริษัทในกลุ่ม ผู้ได้รับสิทธิจากบริษัทให้ดำเนินการภายใต้ Saypilot Platform และคู่ค้าทางธุรกิจของบริษัท</li>
        </ul> 
        <p>ข้อมูลซึ่งบริษัทได้รับจาก หรือผ่าน Saypilot Platform ในรูปแบบต่างๆ ซึ่งรวมถึงข้อมูลที่เราอาจใช้เทคโนโลยีจัดเก็บฐานข้อมูลแบบอัตโนมัติ (automatic data collection technologies) เพื่อเก็บรวบรวมข้อมูลนั้นๆ ซึ่งประกอบไปด้วย</p> 
        <ul className="list-bullet-gray">
            <li>ข้อมูลที่ท่านได้กรอกแบบฟอร์มบน Saypilot Platform ซึ่งรวมถึง ข้อมูลที่ให้ไว้ในขณะที่
				<ul className="list-bullet-border-gray">
          <li>ลงทะเบียนเพื่อใช้ Saypilot Platform</li> 
        <li>ลงชื่อติดตาม (subscribing) บริการของบริษัท</li> 
        <li>ประกาศข้อความผ่านอินเทอร์เน็ต</li> 
        <li>การร้องขอบริการเพิ่มเติม หรือ</li> 
        <li>ข้อมูลที่ท่านรายงานปัญหาเกี่ยวกับ Saypilot Platform</li>
        </ul>
        </li> 
        <li>บันทึก และสำเนาการติดต่อสื่อสารระหว่างกันในรูปแบบต่างๆ รวมถึง การติดต่อผ่านอีเมล</li> 
        <li>รายละเอียดของธุรกรรมที่ท่านทำผ่าน Tellscrore Platform อาทิเช่น การสร้างแคมเปญ การกำหนดกลุ่มเป้าหมาย ชื่อสินค้าหรือบริการ คำอธิบายสินค้า จุดเด่นของสินค้าหรือบริการ คู่แข่ง การสั่งงาน เป้าหมายงาน</li> 
        <li>รายละเอียดในการปฏิบัติตามคำสั่งของท่าน โดยท่านอาจถูกร้องขอให้แจ้งข้อมูลทางการเงินก่อนทำคำสั่งซื้อผ่านทาง Tellscrore Platform</li> 
        <li>คำค้นหาของท่านที่ระบุบน Saypilot Platform</li> 
          <li>ข้อมูลที่ถูกท่านเผยแพร่ หรือแสดงข้อมูลบนพื้นที่สาธารณะของ Saypilot Platform (“ประกาศ”) หรือส่งข้อมูลผ่านไปยังบุคคลอื่นๆ ที่ใช้ Saypilot Platform หรือบุคคลภายนอก (“เนื้อหาของผู้ใช้”)
            <br/>
            <br/> 
            <u>หมายเหตุ</u>&nbsp;การที่ท่านเผยแพร่ประกาศ และ/หรือส่งเนื้อหาของผู้ใช้รายอื่นผ่าน Saypilot Platform บริษัทจะถือว่าท่านได้ทราบและยอมรับความเสี่ยงที่อาจจะเกิดขึ้น ทั้งนี้ แม้ว่าท่านอาจกำหนดการตั้งค่าความเป็นส่วนตัวสำหรับข้อมูลดังกล่าวได้ โดยเข้าสู่ระบบบัญชีส่วนตัวของท่านก็ตาม บริษัทขอเรียนให้ท่านทราบว่าไม่มีมาตรการรักษาความปลอดภัยใดที่จะสมบูรณ์แบบ หรือไม่สามารถเข้าถึงได้ บริษัทไม่สามารถควบคุมการกระทำของผู้ใช้รายอื่น ซึ่งอาจเผยแพร่ประกาศและ/หรือเนื้อหาของผู้ใช้ที่ท่านให้แก่บุคคลอื่นๆ ดังนั้น บริษัทไม่สามารถและไม่รับประกันได้ว่า การประกาศและ/หรือการส่งเนื้อหาของผู้ใช้ของท่านจะไม่ถูกพบเห็นโดยบุคคลที่ไม่พึงประสงค์ อย่างไรก็ตาม บริษัทได้ตระหนักและปฏิบัติตามมาตรฐานในการรักษาความปลอดภัยของข้อมูลและความปลอดภัยทางเทคโนโลยีสารสนเทศในระดับสากลอย่างเต็มที่ที่สุดแล้ว				</li> 
      <li>รายละเอียดการเข้าเยี่ยมชม Saypilot Platform รวมถึงข้อมูลจราจรทางคอมพิวเตอร์ (traffic data) ข้อมูลตำแหน่งที่ตั้ง บันทึกข้อมูลเรียงตามลำดับเวลา (logs) และข้อมูลการติดต่อสื่อสารอื่น และแหล่งที่ท่านเข้าถึง และใช้บน Saypilot Platform</li> 
        <li>ข้อมูลเกี่ยวกับคอมพิวเตอร์ การเชื่อมต่ออินเทอร์เน็ตของท่าน รวมถึงที่อยู่บนเครือข่ายของคอมพิวเตอร์ (IP addresses) ระบบปฏิบัติการ และประเภทของเบราเซอร์ (browser type)</li></ul></div> <div className="sub"><h3 className="title-with-border sub-title">4.3 ระยะเวลาในการจัดเก็บข้อมูล</h3> <p>เพื่อประโยชน์ของท่าน บริษัทจะเก็บข้อมูลส่วนบุคคลของท่าน รวมทั้งประวัติการแก้ไขเพิ่มเติมข้อมูล ไว้ในฐานข้อมูลของบริษัทตลอดระยะเวลาที่ท่านยังไม่ได้ถอนความยินยอมหรือใช้สิทธิลบข้อมูลส่วนบุคคลของท่าน และบริษัทใคร่ขอเรียนว่า หากท่านใช้สิทธิลบข้อมูลส่วนบุคคลของท่านแล้ว ข้อมูลส่วนบุคคลนั้นจะถูกทำลายไปโดยทันทีและบริษัทจะไม่สามารถดำเนินการกู้คืนข้อมูลดังกล่าวได้ ไม่ว่าในกรณีใด</p></div></div></section>
         <section>
        <h3 className="title-with-border">5. บริษัทอนุญาตให้ใครเข้าถึงข้อมูลของท่านได้บ้าง</h3> <div className="_f-system"><div className="sub"><h3 className="title-with-border sub-title">5.1 การใช้ เปิดเผย หรือถ่ายทอดข้อมูล</h3> <p>นอกจากการเก็บรวบรวมข้อมูลข้างต้นแล้ว บริษัทจำเป็นต้องนำข้อมูลของท่านไปใช้ เปิดเผย หรือถ่ายทอดให้แก่ Influencer หรือ Marketer หรือบุคคลอื่นที่เกี่ยวข้องกับ Saypilot Platform ไม่ว่าอยู่ในประเทศหรือต่างประเทศ ซึ่งรวมถึง</p> <ul className="list-bullet-gray">
          <li>บริษัทย่อย บริษัทในเครือ บริษัทในกลุ่ม</li> 
        <li>หน่วยงานราชการ</li> 
        <li>ผู้ได้รับสิทธิจากบริษัทให้ดำเนินการภายใต้ Saypilot Platform และคู่ค้าทางธุรกิจของบริษัท</li> 
        <li>ให้แก่ผู้รับเหมา ผู้ให้บริการ หรือบุคคลภายนอกอื่น ซึ่งให้การสนับสนุนธุรกิจของบริษัทซึ่งเข้าทำสัญญาการให้และ/หรือรับบริการจากบริษัท ไม่ว่าจะตั้งอยู่ในประเทศหรือต่างประเทศ โดยหน่วยงานดังกล่าวยอมรับที่จะปฏิบัติตามนโยบายนี้รวมถึงแต่ไม่จำกัดเพียง บริษัทด้านการจัดการ Influencer ผู้จัดการ Influencer บริษัทด้านเทคโนโลยี, ด้านการสื่อสารโทรคมนาคม, พัฒนาซอฟต์แวร์ บริษัทด้านความปลอดภัยทางเทคโนโลยีสารสนเทศ บริษัทด้านการสื่อสารหรือโฆษณาประชาสัมพันธ์ บริษัทโลจิสติกส์</li> 
        <li>ให้แก่ผู้ซื้อ หรือผู้สืบสิทธิอื่นในกรณีมีการควบรวม การขายกิจการ การปรับโครงสร้างทั่วไป การปรับโครงสร้างองค์กร การเลิกกิจการ หรือการขาย หรือโอนลักษณะอื่นซึ่งสินทรัพย์เพียงบางส่วน หรือทั้งหมดของเรา ไม่ว่าโดยการดำเนินธุรกิจตามปกติ หรือเป็นส่วนหนึ่งของการล้มละลาย การชำระบัญชี หรือกระบวนการในทำนองเดียวกัน ซึ่งข้อมูลส่วนบุคคลที่บริษัทครอบครองอยู่อันเกี่ยวกับ Saypilot Platform สำหรับผู้ใช้นั้นรวมอยู่ในสินทรัพย์ที่โอนด้วย</li> 
        <li>ให้แก่บุคคลภายนอกที่ต้องการทำการตลาดสำหรับสินค้าหรือบริการกับท่าน โดยที่ท่านไม่ได้ถอนความยินยอมในการเปิดเผยข้อมูลของท่าน</li> 
        <li>ให้แก่บุคคลใดๆ เพื่อให้บรรลุจุดมุ่งหมายของ Saypilot Platform ตามที่ได้กล่าวไว้ในหัวข้อที่ 3 แล้ว</li></ul> <p>ในกรณีที่บริษัทต้องการเปิดเผยข้อมูลส่วนบุคคลของท่านแก่บุคคลอื่นนอกจากจากที่ระบุไว้ข้างต้น บริษัทและแจ้งให้ท่านรับทราบและขอความยินยอมจากท่านอีกครั้งหนึ่ง</p></div> <div className="sub"><h3 className="title-with-border sub-title">5.2 การส่ง หรือโอนข้อมูลให้แก่บุคคลในประเทศอื่น</h3> <p>ในบางครั้ง บริษัทอาจมีความจำเป็นต้องส่ง หรือโอนข้อมูลของท่านให้แก่บุคคลในประเทศอื่น แต่ทั้งนี้ บริษัทจะใช้ความพยายามอย่างดีที่สุด ที่จะพิจารณาว่าผู้ที่ได้รับการส่ง หรือรับโอนข้อมูลของท่านจะมีมาตรการให้ความคุ้มครองข้อมูลส่วนบุคคลที่ไม่ต่ำไปกว่านโยบายความฉบับนี้ อย่างไรก็ตาม ในกรณีที่บุคคลในประเทศอื่นนั้นมีมาตรฐานการคุ้มครองข้อมูลส่วนบุคคลที่ต่ำไปกว่านโยบายนี้ บริษัทจะแจ้งให้ท่านพิจารณาและขอความยินยอมจากท่านอีกครั้ง และหากท่านเห็นว่ามาตรฐานการคุ้มครองข้อมูลส่วนบุคคลไม่เพียงพอ ท่านสามารถร้องขอให้บริษัทระงับการส่งหรือโอนข้อมูลของท่านให้แก่บุคคลในประเทศอื่นได้ตามช่องทางที่บริษัทกำหนดไว้ในหัวข้อที่ 2</p> <h3 className="title-with-border sub-title">5.3 การใช้คุกกี้โดยบุคคลภายนอก และเทคโนโลยีการติดตามอื่น</h3> <p>เนื้อหา และแอปพลิเคชันในบางส่วน รวมถึงโฆษณาบน เทลสกอร์แพลตฟอร์ม นั้น ดำเนินการโดยบุคคลภายนอก รวมไปถึงผู้โฆษณา เครือข่ายโฆษณา (ad networks) และเซอร์เวอร์ ผู้ให้บริการเนื้อหา และผู้ให้บริการแอปพลิเคชัน ซึ่งบุคคลภายนอกเหล่านี้อาจใช้คุกกี้เพียงอย่างเดียว หรือใช้ร่วมกับเว็บไซต์ บีคอนส์ หรือเทคโนโลยีการติดตามอื่น เพื่อเก็บรวบรวมข้อมูลเกี่ยวกับท่านเมื่อท่านใช้ Saypilot Platformทั้งนี้ ข้อมูลที่พวกเขาเก็บรวบรวมอาจเกี่ยวโยงกับข้อมูลส่วนบุคคลของท่าน หรือพวกผู้ให้บริการอาจรวบรวมข้อมูล ซึ่งรวมถึงข้อมูลส่วนบุคคลเกี่ยวกับกิจกรรมทางออนไลน์ตามช่วงเวลา หรือ จาก Saypilot Platformอื่นที่ต่างกัน และบริการออนไลน์อื่นๆ โดยพวกเขาอาจใช้ข้อมูลนี้เพื่อจัดหาโฆษณาซึ่งตรงกับความสนใจ (เชิงพฤติกรรม) ของท่าน หรือเนื้อหาที่สนใจอื่นๆ</p> <p>บริษัทไม่ได้ควบคุมเทคโนโลยีการติดตามต่างๆเหล่านี้ของบุคคลภายนอก หรือวิธีการที่เทคโนโลยีนั้นจะถูกใช้งาน หากท่านมีคำถามเกี่ยวกับการโฆษณา หรือเนื้อหาที่น่าสนใจอื่นๆ ท่านควรติดต่อกับผู้ให้บริการซึ่งรับผิดชอบโดยตรง</p> <h3 className="title-with-border sub-title">5.4 การเปิดเผยข้อมูลในกรณีอื่นๆ</h3> <ul className="list-bullet-gray">
          <li>เพื่อปฏิบัติตามคำสั่งศาล กฎหมาย หรือกระบวนการทางกฎหมาย รวมถึงเพื่อดำเนินการตามการร้องขอของเจ้าหน้าที่ตามกฎหมาย หรือทางราชการ</li> 
        <li>เพื่อบังคับตาม หรือบังคับใช้ ข้อกำหนดการใช้งานของบริษัท และสัญญาฉบับอื่น รวมถึงเพื่อวัตถุประสงค์ในการแจ้งยอดหนี้ และการเรียกเก็บเงิน</li> 
        <li>หากบริษัทเห็นว่าการเปิดเผยนั้นมีความจำเป็น หรือเหมาะสมเพื่อการปกป้องสิทธิ ทรัพย์สิน หรือเพื่อความปลอดภัยของบริษัท ลูกค้า หรือบุคคลอื่น ซึ่งรวมถึงการแลกเปลี่ยนข้อมูลกันระหว่างบริษัท และองค์กรอื่น เพื่อวัตถุประสงค์ในการป้องกันการฉ้อฉล และลดความเสี่ยงจากการผิดนัดชำระหนี้ (Credit risk)</li> 
        <li>เพื่อให้บรรลุวัตถุประสงค์ที่เกี่ยวกับการจัดทำเอกสารประวัติศาสตร์หรือจดหมายเหตุ เพื่อประโยชน์สาธารณะ หรือที่เกี่ยวกับการศึกษาวิจัยหรือสถิติซึ่งได้จัดให้มีมาตรการปกป้องที่เหมาะสม เพื่อคุ้มครองสิทธิและเสรีภาพของเจ้าของข้อมูลส่วนบุคคล</li> 
        <li>เพื่อป้องกันหรือระงับอันตรายต่อชีวิต ร่างกาย หรือสุขภาพของบุคคล</li> 
          <li>เป็นการจำเป็นเพื่อการปฏิบัติหน้าที่ในการดำเนินภารกิจเพื่อประโยชน์สาธารณะของบริษัท หรือปฏิบัติหน้าที่ในการใช้อำนาจรัฐที่ได้มอบให้แก่บริษัท</li>
          </ul>
          </div>
          </div>
          </section>
           <section>
          <h3 className="title-with-border">6. บริษัทคำนึงถึงสิทธิของท่านผู้เป็นเจ้าของข้อมูลอย่างไร</h3>
           <div className="_f-system"><p>ท่านในฐานะเจ้าของข้อมูลมีสิทธิต่าง ๆ ดังนี้</p>
            <div className="sub"><h3 className="title-with-border sub-title">6.1 สิทธิเข้าถึงข้อมูลส่วนบุคคลของท่าน</h3>
             <p>ท่านสามารถเข้าถึงข้อมูลส่วนบุคคลของท่านที่อยู่ภายในความรับผิดชอบของบริษัท เพื่อตรวจสอบและเปลี่ยนแปลงข้อมูลส่วนบุคคลของท่าน และเข้าเยี่ยมชมหน้าบัญชีส่วนตัวของท่าน โดยการเข้าสู่ระบบ Saypilot Platform ได้ตลอดเวลา</p> 
             <p>ทั้งนี้ การเข้าถึงหรือการใช้งานที่เหมาะสมซึ่งข้อมูลที่อยู่บน Saypilot Platform รวมถึง เนื้อหาของผู้ใช้นั้นอยู่ภายใต้บังคับของข้อกำหนดการใช้งานของบริษัท</p> 
             <h3 className="title-with-border sub-title">6.2 สิทธิขอรับสำเนาข้อมูลส่วนบุคคลของท่าน</h3> 
             <p>ท่านสามารถขอรับสำเนาข้อมูลส่วนบุคคลของท่านที่อยู่ภายใต้ความรับผิดชอบของบริษัทได้ ตามวิธีการและช่องทางที่บริษัทกำหนดไว้ในหัวข้อที่ 2</p> 
             <h3 className="title-with-border sub-title">6.3 สิทธิขอให้เปิดเผยถึงการได้มาซึ่งข้อมูลส่วนบุคคลที่ท่านไม่ได้ให้ความยินยอม</h3>
              <p>ในกรณีที่บริษัทได้เก็บรวบรวมข้อมูลจากแหล่งอื่นตามที่ท่านระบุไว้ในหัวข้อที่ 4 ท่านสามารถร้องขอให้บริษัทเปิดเผยถึงการได้มาซึ่งข้อมูลดังกล่าวได้ตามวิธีการและช่องทางที่บริษัทกำหนดไว้ในหัวข้อที่ 2</p>
               <h3 className="title-with-border sub-title">6.4 สิทธิคัดค้านการเก็บรวบรวม ใช้ หรือการเปิดเผยข้อมูลส่วนบุคคลของท่าน</h3>
                <p>บริษัทตระหนักดีถึงความสำคัญของข้อมูลส่วนบุคคลของท่าน ดังนั้น ท่านสามารถคัดค้านการเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคลของท่านต่อบริษัทได้ตลอดเวลา เว้นแต่บริษัทจะมีสิทธิโดยชอบตามกฎหมายที่จะปฏิเสธการคำคัดค้านของท่าน</p>
                 <h3 className="title-with-border sub-title">6.5 สิทธิในการลบ หรือขอให้ทำลาย หรือระงับการใช้ชั่วคราว หรือแปลงข้อมูลให้อยู่ในรูปแบบข้อมูลที่ไม่ระบุชื่อ</h3> 
                 <p>เว้นแต่ บริษัทมีหน้าที่ต้องปฏิบัติตามที่กฎหมายกำหนดไว้เป็นการเฉพาะหรือข้อมูลส่วนบุคคลที่บริษัทเก็บรวบรวมไว้เพื่อวัตถุประสงค์ในการใช้เสรีภาพในการแสดงความคิดเห็น ท่านสามารถลบข้อมูลของท่านออกจาก Saypilot Platform แล้วสำเนาข้อมูลของท่านเก็บไว้ รวมถึงการร้องขอให้บริษัทระงับการใช้ข้อมูลส่วนบุคคลของท่านไว้เป็นการชั่วคราว อย่างไรก็ตามสำเนาข้อมูลของท่านอาจจะยังสามารถถูกพบเห็นได้ในหน่วยเก็บความจำชั่วคราวขนาดเล็ก หรือหน้าเว็บที่ถูกบันทึก (cached and archived pages) หรืออาจถูกทำสำเนา หรือเก็บรักษาโดยผู้ใช้รายอื่นภายใต้ Saypilot Platform</p>
                  <p>หากบริษัทไม่ปฏิบัติตามนโยบาย หรือกฎหมายที่เกี่ยวข้อง ท่านสามารถขอให้บริษัททำลาย หรือระงับใช้ชั่วคราว หรือแปลงข้อมูลให้อยู่ในรูปแบบข้อมูลที่ไม่ระบุชื่อได้&nbsp;เว้นแต่ กฎหมายจะกำหนดให้บริษัทยังคงมีหน้าที่ต้องเก็บรักษาข้อมูลนั้นต่อไป</p> 
                  <h3 className="title-with-border sub-title">6.6 สิทธิขอให้ทำข้อมูลให้เป็นปัจจุบัน สมบูรณ์และไม่ก่อให้เกิดความเข้าใจผิด</h3> 
                  <p>ในกรณีที่ข้อมูลส่วนบุคคลของท่านไม่เป็นปัจจุบัน ไม่สมบูรณ์ ซึ่งอาจจะก่อให้เกิดความเข้าใจผิดต่อบุคคลภายนอกได้ ท่านสามารถดำเนินการปรับปรุงข้อมูลส่วนบุคคลของท่านให้เป็นปัจจุบัน สมบูรณ์และไม่ก่อให้เกิดความเข้าผิดได้ตลอดเวลาผ่าน Saypilot Platform ด้วยตัวของท่านเอง อย่างไรก็ตาม หากระบบของบริษัทมีความผิดพลาดหรือท่านพบปัญหาหรืออุปสรรคใด ทำให้ท่านไม่สามารถดำเนินการด้วยตนเองได้ ท่านสามารถแจ้งให้บริษัทดำเนินการได้ตามวิธีและช่องทางที่บริษัทกำหนดไว้ในหัวข้อที่ 2</p>
                   <h3 className="title-with-border sub-title">6.7 สิทธิร้องเรียนต่อหน่วยงานที่เกี่ยวข้อง</h3>
                    <p>ในกรณีที่บริษัทเป็นผู้ควบคุมข้อมูลตามนิยามในพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 หากบริษัทไม่ปฏิบัติตามการร้องขอหรือการใช้สิทธิของท่าน ท่านในฐานะเจ้าของข้อมูลส่วนบุคคลย่อมมีสิทธิร้องเรียนบริษัทต่อหน่วยงานที่เกี่ยวข้องและมีหน้าที่รับผิดชอบได้</p> 
                    <p>ทั้งนี้ บริษัทขอเรียนชี้แจงว่าการใช้สิทธิของท่านตามที่ปรากฎในหัวข้อ 6 นี้จะต้องไม่เป็นก่อให้เกิดความเสียหายต่อสิทธิและเสรีภาพของบุคคลอื่น หากเป็นกรณีดังกล่าว หรือเป็นกรณีที่บริษัทจำเป็นต้องปฏิบัติตามกฎหมายหรือคำสั่งศาล บริษัทขอสงวนสิทธิที่จะไม่ดำเนินการตามคำขอของท่าน</p>
                    </div>
                    </div>
                    </section>
           <section>
        <h3 className="title-with-border">7. การใช้งาน การดูแลรักษา การป้องกัน</h3>
         <div className="_f-system">
           <p>เราอาจใช้เทคโนโลยีจัดเก็บฐานข้อมูลแบบอัตโนมัติ (automatic data collection technologies) ดังต่อไปนี้</p>
          <div className="sub">
            <h3 className="title-with-border sub-title">7.1 บันทึกข้อมูลการเยี่ยมชมเว็บไซต์ หรือ คุกกี้ (Cookies) หรือ (browser cookies)</h3> 
            <p>คุกกี้เป็นไฟล์ขนาดเล็กซึ่งบันทึกอยู่ในอุปกรณ์บันทึกข้อมูล (Hard drive) ของคอมพิวเตอร์ของท่าน ซึ่งท่านอาจปฏิเสธที่จะยอมรับ browser cookies ได้ โดยการเปิดใช้งานการตั้งค่าที่เหมาะสมบน browser ของท่าน อย่างไรก็ตาม หากท่านเลือกการตั้งค่าเช่นนี้ ท่านอาจไม่สามารถเข้าถึงบางส่วนของ Saypilot Platform ได้ ทั้งนี้ เนื่องจาก Saypilot Platform จะสร้าง Cookies ขึ้นมา ดังนั้น ท่านจึงได้ปรับการตั้งค่า browser ของท่านที่ปฏิเสธ Cookies ที่ Saypilot Platform สร้างขึ้น</p> 
            <h3 className="title-with-border sub-title">7.2 แฟลช คุกกี้ (Flash Cookies)</h3> 
            <p>ลักษณะพิเศษบางประการของ Saypilot Platform นั้นอาจใช้ข้อมูลที่จัดเก็บในคอมพิวเตอร์ (local stored objects) (หรือ Flash Cookies) เพื่อรวบรวม และจัดเก็บข้อมูลเกี่ยวกับความชอบส่วนตัว และการนำท่านไปยัง หรือจาก และบน Saypilot Platform ทั้งนี้ Flash Cookies ไม่ได้ถูกจัดการโดยการตั้งค่า browser เหมือนกับที่ใช้สำหรับ browser cookies สำหรับข้อมูลเกี่ยวกับการจัดการความเป็นส่วนตัวของท่าน และการตั้งค่าการรักษาความปลอดภัยสำหรับ Flash Cookies นั้น โปรดอ่านหัวข้อ วิธีการที่บริษัทใช้ และเปิดเผยข้อมูลของท่านในข้อ 7.4</p> 
            <h3 className="title-with-border sub-title">7.3 เว็บ บีคอนส์ (Web Beacons)</h3> <p>หน้าเว็บของ Saypilot Platform และ email ของบริษัท อาจมีไฟล์อิเล็กทรอนิกส์ขนาดเล็ก ที่รู้กันในชื่อ Web Beacons ประกอบอยู่ หรือบางครั้งรู้จักในชื่อ กิฟส์ (gifs) พิกเซล แทกซ์ (pixel tags) และ กิฟส์แบบพิกเซลเดี่ยว (single-pixel gifs) ซึ่งทำให้บริษัทสามารถนับจำนวนผู้ใช้ที่เข้าเยี่ยมชม Saypilot Platform หรือ ผู้ใช้ที่รับอีเมล์ของบริษัท และข้อมูลสถิติอื่นที่เกี่ยวข้องกับ Saypilot Platform อาทิเช่น การบันทึกเนื้อหาบน Saypilot Platform ที่ได้รับความนิยม, การตรวจสอบระบบ และความสมบูรณ์ของเซอร์เวอร์ (Server)</p> 
            <h3 className="title-with-border sub-title">7.4 ทางเลือกเกี่ยวกับวิธีการใช้งาน และเปิดเผยข้อมูลของท่าน</h3>
             <p>บริษัทมุ่งมั่นที่จะมอบทางเลือกต่างๆ ให้แก่ท่านสำหรับข้อมูลส่วนบุคคลที่ท่านให้ไว้แก่บริษัทนั้น บริษัทได้สร้างกลไกสำหรับท่านเพื่อจัดให้มีการควบคุมข้อมูลของท่าน ดังนี้:</p> 
             <ul className="list-bullet-gray">
          <li>
            <p>เทคโนโลยีการติดตาม และโฆษณา</p>
            <p>ท่านสามารถตั้งค่า browser เพื่อปฏิเสธ browser cookies ทั้งหมดหรือบางส่วน หรือเพื่อแจ้งเตือนท่านในเวลาที่มีการส่ง cookies ทั้งนี้ เพื่อศึกษาวิธีการจัดการกับการตั้งค่าสำหรับ Flash Cookies ให้ท่านเข้าเยี่ยมชมหน้าเว็บไซต์การตั้งค่าสำหรับ Flash Player บน Saypilot Platform ของ Adobe's Saypilot Platform ซึ่งหากท่านยกเลิกการทำงาน หรือปฏิเสธ cookies โปรดทราบว่าบางส่วนของเว็บไซต์นี้อาจจะไม่สามารถเข้าถึงได้ หรือไม่สามารถทำงานได้อย่างเหมาะสม</p>
            </li> 
        <li>
          <p>การเปิดเผยข้อมูลของท่านสำหรับการโฆษณาของบุคคลภายนอก</p>
        <p>หากท่านไม่ต้องการให้บริษัทแบ่งปันข้อมูลส่วนบุคคลของท่านให้แก่บุคคลภายนอก ซึ่งไม่ใช่บริษัทในเครือ หรือที่ไม่ใช่ตัวแทน เพื่อวัตถุประสงค์ในการส่งเสริมการขายนั้น ท่านสามารถเลือกที่จะเพิกถอนความยินยอมได้ นอกจากนี้ ท่านสามารถทำการยกเลิกคำสั่งได้ตลอดเวลา โดยการเข้าสู่ระบบ Saypilot Platform และทำการปรับเปลี่ยนในหัวข้อความชอบของผู้ใช้ในบัญชีส่วนตัวของท่าน โดยการเลือก หรือยกเลิก กล่องตั้งค่าที่เกี่ยวข้อง หรือโดยส่งอีเมล์มาที่ <a href="mailto:contact@Saypilot.com">contact@Saypilot.com</a> พร้อมระบุความประสงค์ของท่าน</p></li> 
        <li>
          <p>ข้อเสนอส่งเสริมการขาย</p>
        <p>หากท่านไม่ประสงค์ให้ที่อยู่อีเมล์ /ข้อมูลการติดต่อของท่านถูกใช้ในการส่งเสริมการขายสินค้า หรือบริการของเรา หรือของบุคคลภายนอก ท่านสามารถเลือกที่จะเพิกถอนความยินยอมได้ หรือเข้าสู่ระบบ Saypilot Platform เพื่อปรับเปลี่ยนในหัวข้อความชอบของผู้ใช้ในบัญชีส่วนตัวของท่าน โดยการเลือกหรือยกเลิก กล่องตั้งค่าที่เกี่ยวข้อง หรือโดยส่งมาที่ <a href="mailto:contact@Saypilot.com">contact@Saypilot.com</a> พร้อมระบุความประสงค์ของท่าน</p>
        <p>หากท่านได้รับอีเมลส่งเสริมการขายจากเรา ท่านอาจส่งอีเมลตอบกลับ เพื่อขอยกเลิกการส่งอีเมลอื่นในอนาคต ทั้งนี้ การยกเลิกคำสั่งนั้นไม่มีผลบังคับถึงข้อมูลที่ท่านได้เคยให้ไว้ก่อนหน้านี้ อันเนื่องมาจากการซื้อสินค้า การลงทะเบียนการรับประกัน การรับบริการเกี่ยวกับสินค้า หรือธุรกรรมอื่นๆ</p></li> 
          <li>
            <p>การโฆษณาตามเป้าหมาย</p>
          <p>หากท่านไม่ต้องการให้เราใช้ข้อมูลที่เก็บรวบรวมไว้ หรือที่ท่านได้ให้ไว้แก่เราในการส่งโฆษณาตามการตั้งค่าความชอบของผู้ชมซึ่งเป็นกลุ่มเป้าหมายของผู้โฆษณา (advertisers' target-follower preferences) นั้น ท่านสามารถเลือกที่จะเพิกถอนความยินยอมได้ โดยท่านสามารถปรับเปลี่ยนความชอบส่วนตัวของผู้ใช้สำหรับโฆษณาได้ในบัญชีส่วนตัวของท่าน โดยการเลือกหรือยกเลิกกล่องตั้งค่าที่เกี่ยวข้อง หรือโดยส่งอมาที่ <a href="mailto:contact@Saypilot.com">contact@Saypilot.com</a> พร้อมระบุความประสงค์ของท่าน</p>
          <p>บริษัทไม่มีมาตรการควบคุมการเก็บรวบรวม หรือการใช้ข้อมูลของท่านโดยบุคคลภายนอก เพื่อดำเนินการด้านโฆษณาตามความสนใจ (interest-based advertising) อย่างไรก็ตาม บุคคลภายนอกเหล่านี้ อาจดำเนินการเพื่อให้ท่านสามารถเลือกที่จะไม่ให้ข้อมูลของท่านถูกเก็บรวบรวม หรือถูกใช้งานด้วยวิธีนี้</p></li></ul></div></div></section>
          <br/> 
          <section>
          <h3 className="title-with-border">8. การเปลี่ยนแปลงของนโยบายการเก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคล</h3> 
          <div className="_f-system">
            <p>บริษัทสงวนสิทธิในการแก้ไข เปลี่ยนแปลงนโยบายการเก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลฉบับนี้ (รวมถึงฉบับแก้ไข) เพื่อให้สอดคล้องกับสถานการณ์ กฎ ระเบียบ ประกาศ หรือกฎหมายที่จะเกิดขึ้นในอนาคต ทั้งนี้ บริษัทจะประกาศเกี่ยวกับการเปลี่ยนแปลงใดๆ ของนโยบายนี้ในหน้าเว็บไซต์ Saypilot Platform หากมีการเปลี่ยนแปลงในสาระสำคัญ ถึงวิธีการดูแลข้อมูลส่วนบุคคลนั้น บริษัทจะแจ้งเตือนบนหน้าหลักของ Saypilot Platform ทั้งนี้ วันที่นโยบายความเป็นส่วนตัวได้รับการปรับปรุงครั้งล่าสุดนั้น จะถูกระบุไว้บริเวณส่วนบนสุดของหน้าเว็บไซต์ Saypilot Platform บริษัทขอย้ำเตือนว่า เพื่อประโยชน์ของตัวท่านเอง ท่านจะต้องติดตาม Saypilot Platform เป็นประจำ เพื่อให้ทราบถึงการเปลี่ยนแปลงใดๆ ที่อาจจะเกิดขึ้น รวมถึงเรื่องนโยบาย (ถ้ามี) และถือเป็นหน้าที่ของท่าน ที่จะต้องทำให้แน่ใจว่า อีเมล์ที่แจ้งไว้บน Saypilot Platform เป็นปัจจุบัน และสามารถใช้งานรับส่งข้อความได้เป็นปกติ</p>
            </div>
            </section>
          </div>
                </div>
